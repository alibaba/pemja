...
PyObject* JcpPyJIterable_New(JNIEnv* env, jobject iterable, jclass clazz) {
  PyObject* self;
...
static PyObject* pyjiterable_iterator(PyObject* self) {
  JNIEnv* env;
  jobject iterator;
...
PyTypeObject PyJIterable_Type = {
    PyVarObject_HEAD_INIT(NULL, 0) "pemja.PyJIterable", /* tp_name */
