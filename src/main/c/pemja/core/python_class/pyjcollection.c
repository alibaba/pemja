...
PyObject* JcpPyJCollection_New(JNIEnv* env, jobject collection, jclass clazz) {
  PyObject* self;
...
static int pyjcollection_contains(PyObject* self, PyObject* o) {
  JNIEnv* env;
  jobject value;
...
PyTypeObject PyJCollection_Type = {
    PyVarObject_HEAD_INIT(NULL, 0) "pemja.PyJCollection", /* tp_name */
