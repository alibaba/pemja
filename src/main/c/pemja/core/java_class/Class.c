...
jstring JavaClass_getName(JNIEnv* env, jobject this) {
  if (!getName) {
...
jobjectArray JavaClass_getConstructors(JNIEnv* env, jobject this) {
  if (!getConstructors) {
...
jobjectArray JavaClass_getMethods(JNIEnv* env, jobject this) {
  if (!getMethods) {
...
jobjectArray JavaClass_getFields(JNIEnv* env, jobject this) {
  if (!getFields) {
...
jclass JavaClass_getComponentType(JNIEnv* env, jobject this) {
  if (!getComponentType) {
...
jboolean JavaClass_isArray(JNIEnv* env, jobject this) {
  if (!isArray) {
